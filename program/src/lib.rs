...
fn process_instruction(
    ...
    let data = &instruction_data[1..len];
    match instruction_data[0] {
        0 => create_campaign(program_id, accounts, data),
        1 => withdraw(program_id, accounts, data),
        2 => donate(program_id, accounts, data),
        _ => {msg!("Didn't find the entrypoint required"); Err(ProgramError::InvalidInstructionData)},
    }
}
